...
_mongodb.MongoClient.connect(process.env.MONGO_URL, { poolSize: 4 }, function (err, database) {
...
app.post('/api/v1/import', function (req, res) {
  var msg = parseMessage(req.body.text);
  (0, _child_process.execFile)(process.env.GPG_PATH, ['--keyserver', 'pgpkeys.mit.edu', '--recv', msg.key], function (err) {
